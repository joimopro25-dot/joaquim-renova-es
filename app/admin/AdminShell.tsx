...
import {
  LayoutDashboard, Users, Briefcase, Receipt, Package, FileText, Inbox, Globe as GlobeIcon, Images, BookMarked, HardHat, UsersRound, Mail, BellRing, Truck, Sparkles,
...
const MENU: MenuItem[] = [
  ...
  { path: '/admin/inspiracao', icon: Sparkles, label: 'Inspiração' },
